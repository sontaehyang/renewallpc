...
public class MonthStatisticsExcelView extends AbstractSXSSFExcelView {

	public MonthStatisticsExcelView() {
		setFileName("월별 통계_" + DateUtils.getToday(Const.DATETIME_FORMAT) + ".xlsx");
	}
	...
	private void buildUserSheet(SXSSFWorkbook workbook, List<DateStatsSummary> list, StatsSummary total) {
		...
		HeaderCell[] headerCells = new HeaderCell[] {
				...
				new HeaderCell(512, MessageUtils.getMessage("M01355")) , //결제
				new HeaderCell(512, "") ,
				new HeaderCell(512, "") ,
				new HeaderCell(512, "") ,
				new HeaderCell(512, "") ,
				...
				new HeaderCell(512, MessageUtils.getMessage("M00037")) , //취소
				new HeaderCell(512, "") ,
				new HeaderCell(512, "") ,
				new HeaderCell(512, "") ,
				new HeaderCell(512, "") ,
		...
		HeaderCell[] headerCells2 = new HeaderCell[] {
				...
				new HeaderCell(512, MessageUtils.getMessage("M01357")) , //건수
				new HeaderCell(812, "상품판매가") ,
				new HeaderCell(812, "할인") ,
				new HeaderCell(812, "판매금액") ,
				new HeaderCell(812, "배송비") ,
				new HeaderCell(812, "소계") ,
				...
				new HeaderCell(812, "판매가") ,
				new HeaderCell(812, "배송비") ,
				new HeaderCell(812, "합계")
		};
