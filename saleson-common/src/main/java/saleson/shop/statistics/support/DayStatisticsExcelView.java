...
public class DayStatisticsExcelView extends AbstractSXSSFExcelView {

	public DayStatisticsExcelView() {
		setFileName("일자별 통계_" + DateUtils.getToday(Const.DATETIME_FORMAT) + ".xlsx");
	}
