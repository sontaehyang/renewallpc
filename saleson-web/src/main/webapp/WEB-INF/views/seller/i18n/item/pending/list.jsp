...
<div class="item_list">
	...
	<form:form modelAttribute="itemParam" method="get">
		...
		<div class="btn_all">
			<div class="btn_left">
				<button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='/seller/item/pending/list';"><span class="glyphicon glyphicon-repeat"></span> ${op:message('M00047')}</button> <!-- 초기화 -->
			</div>
			<div class="btn_right">
				...
				<c:forEach items="${list}" var="item" varStatus="i">
					...
					<tr>
						...
						<td>
							...
							<a href="/seller/item/copy/${item.itemId}" class="btn btn-gradient btn-xs">${op:message('M00788')}</a><br /> <!-- 복사 -->
