...
<div class="item_list">
	...
	<form:form modelAttribute="itemParam" method="get">
					...
					<td>
						<div>
							<p>
								...
								<form:radiobutton path="saleStatus" value="soldOut" label="${op:message('M00693')}" /> <!-- 입하대기 -->
		...
		<div class="btn_all">
			<div class="btn_left">
				<button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='/seller/item/list';"><span class="glyphicon glyphicon-repeat"></span> ${op:message('M00047')}</button> <!-- 초기화 -->
			</div>
			<div class="btn_right">
	...
	<div class="board_list">
			...
			<table class="board_list_table" summary="전체상품리스트">
				...
				<c:forEach items="${list}" var="item" varStatus="i">
					...
					<tr>
						...
						<td>
							<div>
								<a href="javascript:Link.view('/seller/item/edit/${item.itemUserCode}')"><img src="${ shop:loadImage(item.itemUserCode, item.itemImage, 'XS') }" class="item_image" alt="상품이미지" /></a>
							</div>
						</td>
						<td class="left break-word">
							<a href="javascript:Link.view('/seller/item/edit/${item.itemUserCode}')" class="break-word">[${item.itemUserCode}]<br/>${item.itemName}</a>
		...
		<div class="btn_all">
			...
			<div class="btn_right mb0">
				<a href="/seller/item/create" class="btn btn-active btn-sm"><span class="glyphicon glyphicon-plus"></span> ${op:message('M00773')}</a> <!-- 상품등록 -->
                ...
                <a href="javascript:Common.popup('/seller/item/upload-csv', 'upload-csv', 400, 500, 0)" class="btn_write gray_small"><img src="/content/opmanager/images/icon/icon_excel.png" alt=""><span>CSV 업로드</span> </a>
                -->
			</div>
		</div>
...
<page:javascript>
	<script type="text/javascript">
        ...
        function downloadExcel() {
            ...
            Common.popup('/seller/item/download-excel?' + parameters, 'download-excel', 580, 670, 0);
        }

        // 엑셀 업로드
        function uploadExcel() {
            Common.popup('/seller/item/upload-excel', 'upload-excel', 600, 550, 0);
        }
