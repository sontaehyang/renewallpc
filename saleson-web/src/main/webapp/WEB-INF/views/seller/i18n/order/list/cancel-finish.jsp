...
<form:form modelAttribute="orderParam" action="" method="post">
	...
	<div class="board_write">
		...
		<div class="btn_all">
			<div class="btn_left"> 
				<button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='/seller/order/cancel-finish'"><span>${op:message('M00047')}<!-- 초기화 --></span></button>
			</div> 
			<div class="btn_right">
				...
				<c:forEach items="${ list }" var="orderShipping" varStatus="index">
					<c:forEach items="${orderShipping.orderItems}" var="orderItem">
						...
						<tr>
							...
							<td>
								<a href="javascript:Common.popup('/seller/order/cancel-finish/order-detail/${orderItem.orderCode}', 'orderDetail', 1000, 700, 1);">${orderItem.orderCode}</a>
							</td>
							<td class="left">
