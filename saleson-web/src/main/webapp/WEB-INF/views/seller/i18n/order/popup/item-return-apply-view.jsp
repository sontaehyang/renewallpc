		 			...
		 			<tbody>
		 				...
		 				<c:if test="${orderReturnApply.writeBankInfo == true}">
		 					...
		 					<tr>
			 					...
			 					<td>
			 						<div>
			 							은행명 : <form:input path="returnBankName" title="은행명" class="three" maxlength="30"/>
		 						...
		 						<div>
			 						...
			 						<div class="board_guide">
										...
										<p class="tip">
											...
											<c:if test="${orderReturnApply.orderItem.islandType == '1'}"> <strong>(제주)</strong></c:if>
											<c:if test="${orderReturnApply.orderItem.islandType == '2'}"> <strong>(도서산간)</strong></c:if>
											${orderReturnApply.orderItem.orderShippingInfo.receiveAddress} ${orderReturnApply.orderItem.orderShippingInfo.receiveAddressDetail} 
											
											<c:if test="${orderReturnApply.freeShipping == true}">
