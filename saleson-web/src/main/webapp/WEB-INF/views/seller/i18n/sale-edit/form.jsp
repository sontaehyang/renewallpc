...
span.require {color: #e84700; margin-left: 5px;}
		...
		<form:form modelAttribute="item" method="post">
			<input type="hidden" name="sellerId" id="sellerId" value="${sellerContext.seller.sellerId}"/>
			<input type="hidden" name="sellerName" id="sellerName" value="${sellerContext.seller.sellerName}"/>
