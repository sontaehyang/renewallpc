	...
	<div class="popup_wrap">
		...
		<form id="authForm" method="post">
			<div class="popup_contents"> 
				<p class="id_txt">비밀번호를 잊으셨나요? <br>회원가입 시 등록한 본인명의 휴대폰 번호로 인증 후 비밀번호를 새로 설정하실 수 있습니다.</p>
			 						...
			 						<div class="hp_area">
										...
										<div class="input_wrap col-w-9"> 
				 						...
				 						<div class="input_wrap col-w-9"> 	
				 						 ...
				 						 <button type="button" onclick="sendAuthNumber()" class="btn btn-default btn-ms">인증번호 전송</button> 
										
									</div>
			 					</td>
			 				</tr> 
			 				<tr class="auth-number">
			 					...
			 					<td>
			 						...
			 						<p class="certification guide_txt" style="display: none;"></p>
		...
		if ($.validator.isEmpty(requestToken)) {
			...
			$.post(url, $('#authForm').serialize(), function(response){
				if (response.isSuccess) {
					$('#authForm').attr('action', '/users/find-password');
					authCheck = true;
				} else {
