                                                ...
                                                <div class="order_option">
                                                    <a href="/products/view/${orderItem.itemUserCode}"><p class="item_name">${orderItem.itemName}</p></a>
                                                        ...
                                                        <div class="item_price">
                                                           총 렌탈료 : <span>${op:numberFormat(order.rentalMonthAmt * order.rentalPer)}</span>원 / 월 렌탈료 : <span>${op:numberFormat(order.rentalMonthAmt)}</span>원 / 렌탈 개월수 : <span>${op:numberFormat(order.rentalPer)}</span>개월 / <span>${op:numberFormat(orderItem.quantity)}</span>개
                                                        </div>
                                                    </div>
                                                </div><!--// item_info E-->
                                            </td>
