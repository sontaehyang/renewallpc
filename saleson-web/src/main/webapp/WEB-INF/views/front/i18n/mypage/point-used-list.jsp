	...
	<div id="contents" class="pt0"> 
		...
		<div class="contents_inner"> 	   
			...
			<div class="mypage_search_area"> 
				<form:form modelAttribute="pointParam" action="/mypage/${pointType}-used-list" method="get">
					<fieldset>
						<dl>
							<dt>기간별 조회</dt>
							<dd>
			...
			<div class="btn_wrap pt10">
				<div class="btn_left">
					<button type="button" class="btn btn-m btn-default" onclick="location.href='/mypage/${pointType}-used-list'"><img src="/content/images/icon/icon_reset.png" alt="초기화">초기화</button>
				</div> 
			</div><!--// btn_wrap E-->
			
			<div class="tabs tabs-2">
				<ul> 
					<li><a href="/mypage/${pointType}-save-list">적립내역</a></li> 
					<li><a href="javascript:;" class="on">사용내역</a></li> 
				</ul> 
			</div>
	 			...
	 			<table cellpadding="0" cellspacing="0" class="board-list">
		 			...
		 			<tbody>
		 				<c:forEach items="${list}" var="used">
		 					<tr>
			 					<td class="date"><b>${op:date(used.createdDate)}</b></td>
			 					<td>${used.details}</td>
			 					<td class="color_4a4a4a tright"><b>-${op:numberFormat(used.point)}${unit}</b></td>
			 				</tr>
		 				</c:forEach>
		 				...
		 				<c:if test="${empty list}">
							<tr>
			 					<td colspan="3">
			 						<div class="coupon_not">사용내역이 없습니다.</div>
			 					</td> 
			 				</tr> 
						</c:if>	
		 			</tbody>
