...
<script src="//developers.kakao.com/sdk/js/kakao.min.js"></script>
	...
	<c:if test='${!isMypage && !isJoin}'>
	    <a href="javascript:loginWithKakao();" class="sns_image" title="카카오톡 로그인"><img src="/content/images/btn/btn_login_kakao.png" alt="카카오톡 로그인"></a>
    </c:if>
				...
				Kakao.API.request({
					...
					success : function(response) {
						...
						if (isJoined) {
							...
							location.href="/users/sns-join?snsType=kakao";
						}
					},
					fail : function(error) {
