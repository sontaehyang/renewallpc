...
<%@ taglib prefix="module" 	tagdir="/WEB-INF/tags/modules"%>
	...
	<div class="popup_wrap">
		...
		<h1 class="popup_title">기획전 배너영역 ${op:message('M01325')} <!-- 등록 팝업 --> </h1>
		...
		<div class="popup_contents">				
			...
			<form id="promotionForm" method="post" enctype="multipart/form-data" action="/opmanager/mobile-category-edit/promotion-banner/create">
				...
				<div class="board_write">					
					<table summary="기획전 배너영역" class="board_write_table">
						<caption>기획전 배너영역</caption>
						<colgroup>
							<col style="width: 20%;" />
							<col style="width: auto;" />
						</colgroup>
						<tbody>
							<c:forEach begin="0" end="2" var="list" varStatus="i">
								...
								<tr>
									<td class="label">${op:message('M00752')} <!-- 이미지 -->${i.count} ${op:message('M01297')} <!-- 업로드 --></td>
									<td>
										<div>${categoryPromotionList[i.index].editImage}
