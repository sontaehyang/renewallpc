...
<c:set var="orderItem" value="${orderReturnApply.orderItem}" scope="request"/>
		...
		<table class="board_write_table">
			...
			<tbody>
				...
				<tr>   
					...
					<td class="tleft">
						<div>
							${op:numberFormat(orderReturnApply.returnRealShipping)}원
						</div>
					</td> 
				</tr> 
				<tr>   
					...
					<td colspan="3" class="tleft">
						<div>
							${op:nl2br(orderReturnApply.returnMemo)}
						</div>
					</td> 
				</tr> 
			</tbody>
