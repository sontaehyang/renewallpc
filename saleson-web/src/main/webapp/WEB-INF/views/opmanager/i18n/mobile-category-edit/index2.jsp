	...
	<div class="cnt_area mt30">		
		<div id="tab_nav" class="tab_nav col6">
			<ul>
				...
				<li class="on"><a href="/opmanager/mobile-category-edit/index?type=categories">${op:message('M01079')}</a></li> <!-- 카테고리 화면 -->
...
<script type="text/javascript">
	...
	function categoryLayout(){
		...
		$.post("/opmanager/mobile-category-edit/category-layout/"+categoryId , "" , function(resp){
