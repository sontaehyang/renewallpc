...
<h3><span>캠페인</span></h3>
<div class="board_list" id="campaignTable">
	<table class="board_list_table" id="reportTable">
		<colgroup>
...
<page:javascript>
	...
	<script type="text/javascript">
		...
		function view() {
			pagination('campaignTable', 'ga:campaign', 1);
		}

		function initDataList() {
			paginationEvent('#campaignTable', 'campaignTable');
		}
		...
		function pagination(key, dimensions, page) {
			...
			var query = getReportQuery(dimensions, metrics, page, 20);
