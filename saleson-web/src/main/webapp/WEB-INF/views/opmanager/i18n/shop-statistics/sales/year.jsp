...
<div class="location">
	<a href="#">통계</a> &gt;  <a href="#">매출통계</a> &gt; <a href="#" class="on">연도별 매출통계</a>
</div>

<!-- 본문 -->
<div class="statistics_web">
	<h3><span>${op:message('M01410')}</span></h3> <!-- 연도별 매출 -->
	<form:form modelAttribute="statisticsParam" method="get" >
		<div class="board_write">						
			<table class="board_write_table" summary="${op:message('M01410')}"> <!-- 연도별 매출 -->
				<caption>${op:message('M01410')}</caption> <!-- 연도별 매출 -->
				<colgroup>
	...
	<div class="board_list">
		...
		<c:set var="viewType" value="year" scope="request" />
		...
		<sec:authorize access="hasRole('ROLE_EXCEL')">
			<div class="btn_all">
				<div class="right">
					<a href="/opmanager/shop-statistics/sales/year/excel-download?${queryString}" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-save"></span>${op:message('M00254')}</a> <!-- 엑셀 다운로드 -->
				</div>
			</div>
		</sec:authorize>
