...
<%@ taglib prefix="shop"	uri="/WEB-INF/tlds/shop" %>
			...
			<h3><span>메일메거진 템플릿 리스트</span></h3>
			<div class="board_write">
				<table class="board_write_table" summary="메일메거진 템플릿 리스트">
					<caption>메일메거진 템플릿 리스트</caption>
					<colgroup>
						<col style="width:15%;" />
						<col style="width:85%;" />
					</colgroup>
					<tbody>
						<tr>
							<td class="label">템플릿 이름</td>
							<td>
								<div>
									<input type="text" class="seven" title="템플릿 이름">
								</div>
							</td>
						</tr>
					</tbody>
			...
			<div class="board_write">
				<table class="board_list_table" summary="템플릿 리스트">
					...
					<tbody>
						...
						<tr>
							<td><input type="checkbox" name="tempId241" id="tempId241" title="체크박스"></td>							 							 
							<td>ホン·ギルドン</td>
							<td>2014-03-31 14:02:58</td>
							<td>
								<div>
						...
						<tr>
							<td><input type="checkbox" name="tempId242" id="tempId242" title="체크박스"></td>							 							 
							<td>ホン·ギルドン</td>
							<td>2014-03-31 14:02:58</td>
							<td>
								<div>
			...
			<div class="btn_all pt20">
				<!--
				<div class="btn_left">
					<button type="button" class="btn btn-default"><span>삭제</span></button>
				</div>
				-->
				<div class="btn_right">
					<button type="button" class="ctrl_btn"><span>등록</span></button>
				</div>
			</div>
