...
<%@ taglib prefix="shop"	uri="/WEB-INF/tlds/shop" %>
		...
		<form:form modelAttribute="qna" method="post" action="/opmanager/qna-item/delete/${qnaId}">
			...
			<c:choose>
				<c:when test="${qnaAnswer.qnaAnswerId > 0}">
					...
					<div class="btn_center">
						<a href="javascript:history.back();" class="btn btn-default"><span>${op:message('M00480')}</span></a> <!-- 목록 -->
						<a href="/opmanager/qna-item/delete/${qnaId}" id="delete_data" class="btn btn-default">삭제</a>
						<a href="javascript:qnaModify('${qnaId}');" class="btn btn-active">수정</a>
					</div>
				</c:when>
				<c:otherwise>
					<!-- 버튼시작 -->
					<div class="btn_center">
						<a href="javascript:history.back();" class="btn btn-default"><span>${op:message('M00480')}</span></a> <!-- 목록 -->
						<a href="/opmanager/qna-item/delete/${qnaId}" id="delete_data" class="btn btn-default">삭제</a>
						<a href="javascript:qnaModify('${qnaId}');" class="btn btn-active">답변등록</a>
					</div>					
				</c:otherwise>
			</c:choose>
		</div>
...
<script type="text/javascript">
	...
	function qnaModify(qnaId) {
		$("#qna").attr("method", "get").attr("action", "/opmanager/qna-item/answer/"+qnaId).submit();
	}
</script>