...
<form:form modelAttribute="orderParam" action="" method="get">
	...
	<div class="board_write">
		...
		<div class="btn_all">
			<div class="btn_left"> 
				<button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='/opmanager/order/shipping'"><span>${op:message('M00047')}<!-- 초기화 --></span></button>
			</div> 
			<div class="btn_right">
			...
			<tbody>
				<c:forEach items="${ list }" var="orderReturnApply" varStatus="index">
					...
					<tr>
						...
						<td>
							<a href="javascript:Common.popup('/opmanager/order/return-request/order-detail/${orderItem.orderCode}', 'returnRequestDetail', 1000, 700, 1);">${orderItem.orderCode}</a>
							<c:if test="${orderItem.orderItemStatus != '45'}">
								<button type="button" class="btn btn-gradient btn-xs" onclick="Common.popup('/opmanager/order/return-request/process/${orderItem.orderItemId}', 'returnRequestProcess', 700, 500, 1)">환불처리</button>
