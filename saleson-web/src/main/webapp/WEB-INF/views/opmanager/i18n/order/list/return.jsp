				 ...
				 <tr>
				 	...
				 	<td colspan="3">
				 		<div>
							...
							<form:checkbox path="claimStatus" value="03" label=" 환불승인 대기" />
							<form:checkbox path="claimStatus" value="04" label=" 환불 완료" />
				 		</div>
				 	</td>
				 </tr>
			</tbody>
			...
			<tbody>
				...
				<c:forEach items="${ list }" var="apply" varStatus="index">
					...
					<tr style="background:${tdColor};">
						...
						<td> 
							<a href="${requestContext.sellerPage ? '/seller' : '/opmanager'}/order/return/order-detail/${orderItem.orderSequence}/${orderItem.orderCode}?url=${requestContext.currentUrl}">${orderItem.orderCode}</a>
						</td>
