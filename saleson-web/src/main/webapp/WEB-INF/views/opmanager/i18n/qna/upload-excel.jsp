...
<div class="popup_wrap">
	<h1 class="popup_title">Excel ダウンロード</h1>
	
	<div class="popup_contents">
		<form id="editor_upimage" name="editor_upimage" action="/opmanager/qna/upload-excel" method="post" enctype="multipart/form-data">
			...
			<div class="tip mt10">
	      		- <strong>Excel</strong>파일(.xlsx)만 등록할 수 있습니다. (Max file size : 5MB)<br/>
	      	</div>
