...
<input type="hidden" name="userName" value="${user.userName}">	
	...
	<div class="btn_all">
		<div class="btn_left">
			<button type="button" class="btn btn-dark-gray btn-sm" onclick="SendMailLogReset(${userId});"><span class="glyphicon glyphicon-repeat"></span> ${op:message('M00047')}</button> <!-- 초기화 -->
		</div>
		<div class="btn_right">
...
$(function(){
	...
	Manager.activeUserDetails("sendMail");
	...
	$('#searchParam').validator({
		'submitHandler' : function() {
			...
			$.get('/opmanager/user/popup/send-mail-log/list' , $('#searchParam').serialize(), function(html) {
				$('#mailLog-list').html(html);
			});
...
function SendMailLogReset(userId) {
	location.href = '/opmanager/user/popup/send-mail-log-list/'+userId;
}
