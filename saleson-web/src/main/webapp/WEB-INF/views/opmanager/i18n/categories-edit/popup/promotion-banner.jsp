...
<!-- 본문 -->
		<div class="popup_wrap">
			...
			<div class="popup_contents">				
				...
				<form id="promotionForm" method="post" enctype="multipart/form-data" action="/opmanager/categories-edit/promotion-banner/create">
					...
					<div class="board_write">					
						<table class="board_write_table" summary="프로모션 배너영역">
							...
							<tbody>
								<c:forEach begin="0" end="5"  var="list" varStatus="i">
									<c:set var="imageSize" value="(720 x 442)" />
									<c:if test="${i.count > 4}">
										<c:set var="imageSize" value="(176 x 221)" />
									</c:if>
									...
									<tr>
										...
										<td>
											<div>
												<input name="editContents[${i.index}]" type="text" class="w478" title="이미지 ALt ${i.count} " value="${categoryPromotionList[i.index].editContent }" />
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div>
												...
												<c:if test="${categoryPromotionList[i.index].editImage != '' && categoryPromotionList[i.index].editImage != null }">
													<img src="/upload/category-edit/${categoriesEditParam.code}/thumb/${categoryPromotionList[i.index].editImage}" alt="banner" width="180" height="180" />
