	...
	<div class="board_list">
		<table class="board_list_table" summary="이벤트 통계">
			...
			<tr>
				...
				<th scope="col">상품 클릭수</th>
				<th scope="col">상품 구매수(%)</th>
				<th scope="col">상품 구매률(%)</th>
			</tr>
			</thead>
			<tbody>
				<tr>
					<td>${op:numberFormat(totalStatistics.listViewCount)}</td>
					<td>${op:numberFormat(totalStatistics.itemViewCount)}</td>
					<td>${op:numberFormat(totalStatistics.orderCount)}</td>
			...
			<tbody>
				<c:forEach items="${list}" var="list" varStatus="i">
					<tr>
						...
						<td>${empty list.itemUserCode ? "-" : list.itemUserCode}</td>
						<td class="left">${list.itemName}</td>
						<td>${op:numberFormat(list.listViewCount)}</td>
						<td>${op:numberFormat(list.itemViewCount)}</td>
						<td>${op:numberFormat(list.clickedRate)}%</td>
						<td>${op:numberFormat(list.orderCount)}%</td>
