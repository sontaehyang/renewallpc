	      	...
	      	<c:if test="${hasModifyPermission}">
		      	<div id="sm-display-area2" style="display: none">
		      		<form id="shipment" action="/opmanager/shipment-return/create" method="post">
		      			...
		      			<input type="hidden" name="sellerId" value="${shipmentReturn.sellerId}"/>
			      			...
			      			<tr>
			      				...
			      				<td class="lh-2">
			      					<p>
				      					...
				      					<a href="#" class="btn btn-dark-gray btn-sm" onclick="openDaumAddress()">주소찾기</a>
			      					</p>
			      					<div class="line-group">
			      						<input type="text" name="address" class="form-block required" title="주소" />
			      					</div>
			      					<div class="line-group">
...
function shipmentEvent() {
	...
	$('.btn-create').on('click', function() {
		...
		$('#shipment').attr('action', '${requestContext.managerUri}/shipment-return/create');
	});
	...
	$('.btn-edit').on('click', function() {
		...
		$('#shipment').attr('action', '${requestContext.managerUri}/shipment-return/edit');
	});
...
function shipmentDelete() {
	...
	if (confirm("배송정보를 삭제하시겠습니까?")) {
		$('#shipment').attr('action', '${requestContext.managerUri}/shipment-return/delete');
		$('#shipment').submit();
	}
}
