...
<div class="popup_wrap">
	...
	<div class="popup_contents">
		<form id="editor_upimage" name="editor_upimage" action="/opmanager/order/admin/upload-excel" method="post" enctype="multipart/form-data">
			...
			<p class="popup_btns">
				...
				<button type="button" class="btn btn-default" onclick="location.href='/upload/excel/ADMIN_ORDER_SAMPLE.xlsx';"><span>${op:message('M01280')}</span></button> <!-- 샘플 다운로드 -->
