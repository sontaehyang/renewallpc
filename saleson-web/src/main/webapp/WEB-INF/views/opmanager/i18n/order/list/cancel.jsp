...
<form:form modelAttribute="claimApplyParam" method="get">
	...
	<div class="board_write">
				 ...
				 <tr>
				 	...
				 	<td colspan="3">
				 		<div>
							...
							<form:checkbox path="claimStatus" value="03" label=" 환불대기" />
							<form:checkbox path="claimStatus" value="04" label=" 완료" />
		...
		<div class="btn_all">
			<div class="btn_left"> 
				<button type="button" class="btn btn-dark-gray btn-sm" onclick="location.href='${requestContext.sellerPage ? '/seller' : '/opmanager'}/order/cancel/list'"><span class="glyphicon glyphicon-repeat"></span> ${op:message('M00047')}<!-- 초기화 --></button>
			</div> 
			<div class="btn_right">
			...
			<tbody>
				...
				<c:forEach items="${ list }" var="apply" varStatus="index">
					...
					<tr style="background:${tdColor};">
						...
						<td> 
							<a href="${requestContext.sellerPage ? '/seller' : '/opmanager'}/order/cancel/order-detail/${orderItem.orderSequence}/${orderItem.orderCode}?url=${requestContext.currentUrl}">${orderItem.orderCode}</a>
						</td>
