...
<%@ taglib prefix="module" 	tagdir="/WEB-INF/tags/modules"%>
	...
	<div class="popup_wrap">
		...
		<h1 class="popup_title">${op:message('M01324')} <!-- HTML 편집 영역 1 팝업 --> </h1>
		<form id="categoryEditForm" method="post" action="/opmanager/mobile-category-edit/category-create" >
			...
			<div class="popup_contents">				
				...
				<div>
					<textarea name="categoryHeader" id="categoryHeader" cols="30" rows="6" title="메일 내용" class="pop_text">${categories.categoryMobileHtml}</textarea>
				</div>
