		...
		<div id="container">
			<div class="title">
				...
				<ul class="tab_list01 four_tab">				
					...
					<li class="on"><a href="/m/mypage/inquiry-item">상품Q&amp;A</a></li>
				...
				<div class="mypage_wrap">
					...
					<div class="active_con">
						<ul id="op-list-data">
							...
							<jsp:include page="../include/mypage-inquiry-item-list.jsp"></jsp:include>
...
<script type="text/javascript"> 
 ...
 function paginationMore(key) {
 	...
 	$.post('/m/mypage/inquiry-item/list', $("#qnaParam").serialize(), function(html) {
 		$("#op-list-data").append(html);
 		// 더보기 버튼 
 		showHideMoreButton();
 		
 		history.pushState(null, null, "/m/mypage/inquiry-item?" + $("#qnaParam").serialize());
 	});
 }
