			...
			<div class="mypage_wrap">
					...
					<ul>					
						<li>						
							<p class="num">							
								...
								<p class="tit">사용가능 쿠폰</p>
						</li>																
						<li>
							<p class="num"><span>1,200</span>장</p>
							<p class="tit">소멸예정 쿠폰</p>
						</li>
					</ul>
				</div>
				<!-- //active_info -->
							...
							<ul>
								...
								<li>								
									...
									<div class="date_area op-day_btns">
									 	...
									 	<a href="javascript:;" hidden="true" class="btn_date today" >${op:message('M00027')}</a><!-- 1주일 --> 
										<a href="javascript:;" hidden="true" class="btn_date month-1">${op:message('M00029')}</a><!-- 한달 -->    
										<a href="javascript:;" hidden="true" class="btn_date year-1">${op:message('M00029')}</a><!-- 한달 -->    
				...
				<div class="active_con">
					<ul id="op-list-data">
						...
						<jsp:include page="../include/mypage-shipping-list.jsp"></jsp:include>
									
					</ul>
										
					<c:if test="${totalCount > 10 }">	
						<div class="load_more" id="op-list-more">
						<button type="button" class="btn_st2" onclick="javascript:paginationMore('shipping')"><span>더보기</span></button>
						</div>
					</c:if>
				</div>
				<!-- //active_con -->
...
$(function(){
	...
	Mobile.pagination.init('shipping');
...
function paginationMore(key) {
	currentPage++;
	$.post('/m/mypage/shipping/' + currentPage, 'page=' + currentPage, function(html) {
