...
<script type="text/javascript">
	...
	<c:if test="${!isMypage && !isJoin}">
		<li class="login_facebook"><a href="javascript:fb_login();"><span class="logo"><img src="/content/mobile/images/common/login_fb_logo.gif" alt="facebook logo"></span>로그인</a></li>
	</c:if>
        ...
        if (response.authResponse) {
            ...
            FB.api('/me', {fields: 'email, name, id'}, function(response) {
				...
				if (isJoined) {
					...
					location.href="/m/users/sns-join?snsType=facebook";
				}
            });
        } else {
