	...
	<div id="container">
		...
		<div class="con">
			<div class="mypage_wrap">
				...
				<div class="tab_area">
					<ul class="tab_list02">
						<li class="on"><a href="#">적립내역</a></li>
						<li><a href="/m/mypage/${pointType}-used-list">사용내역</a></li>
					</ul>
				</div>
				...
				<div class="active_con">
					<ul id="op-list-data">
						<jsp:include page="../include/mypage-point-save-list.jsp"></jsp:include>
					</ul>
										
					<div class="load_more" id="op-list-more">
					<button type="button" class="btn_st2" onclick="javascript:paginationMore('save-point')"><span>더보기</span></button>
					</div>
...
function paginationMore(key) {
	...
	$.post('/m/mypage/${pointType}-save-list/list', $("#pointParam").serialize(), function(html) {
		$("#op-list-data").append(html);
		
		showHideMoreButton();
		history.pushState(null, null, "/m/mypage/${pointType}-save-list?" + $("#pointParam").serialize());
	});
}
